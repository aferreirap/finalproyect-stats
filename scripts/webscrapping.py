...
### Read the csv 
data=pd.read_csv('/Users/agustinferreira/Desktop/finalproyect-stats/data/app_sample.csv')
...
def image_webscrpping(data,pos_ini,pos_fin):
    ...
    for i in data['App Name'][pos_ini:pos_fin]:
        ...
        try:
            ...
            if '/' in i:
                i=i.split('/')[-1]
            urllib.request.urlretrieve(src, "/Users/agustinferreira/Desktop/finalproyect-stats/data/images/"+i+".png")
        except: 
            a=1
        contador=contador+1
        print(contador)
image_webscrpping(data,3944,5000)